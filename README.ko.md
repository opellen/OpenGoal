...
├── BACKLOG.md       ← 우선순위 큐 (최대 3줄, 목표 아카이브 시 정리)
├── backlog/          ← 상세 분석(open/) 및 드롭/아카이브 이력(archive/)
...
| `BACKLOG.md` | 발견했지만 미뤄둔 건 뭐지? | 목표 아카이브 시 스윕 |
| `backlog/` | 상세 분석과 드롭된 이력은 어디 있지? | 영구 보관 / 아카이브 |
